        ...
        !(function () {
            ...
            function o(t) {
                return void 0 === this || Object.getPrototypeOf(this) !== o.prototype
                    ...
                    : ((N = this),
                      ...
                      (N.tools = new $()),
                      N.isSupported()
                          ? (N.tools.extend(N.defaults, t || {}), (N.defaults.container = r(N.defaults)), (N.store = { elements: {}, containers: [] }), (N.sequences = {}), (N.history = []), (N.uid = 0), (N.initialized = !1))
            ...
            (o.prototype.defaults = {
                ...
                (o.prototype.reveal = function (t, e, n, i) {
                    var o, u, f, g, m, v;
                    if ((void 0 !== e && "number" == typeof e ? ((n = e), (e = {})) : (void 0 !== e && null !== e) || (e = {}), (o = r(e)), (u = s(t, o)), !u.length))
                    ...
                    for (var y = 0; y < u.length; y++)
                        (g = u[y].getAttribute("data-sr-id")),
                            g ? (f = N.store.elements[g]) : ((f = { id: a(), domEl: u[y], seen: !1, revealing: !1 }), f.domEl.setAttribute("data-sr-id", f.id)),
        ...
        !(function (e, n) {
            ...
            function w(t, e) {
                for (var n, i, o = [], r = 0, s = t.length; r < s; r++)
                    (i = t[r]),
                        i.style &&
                            ((n = i.style.display),
                            e ? ("none" === n && ((o[r] = Ft.get(i, "display") || null), o[r] || (i.style.display = "")), "" === i.style.display && zt(i) && (o[r] = x(i))) : "none" !== n && ((o[r] = "none"), Ft.set(i, "display", n)));
            ...
            function E(t, e, n, i, o) {
                ...
                for (f.textContent = "", p = 0; (r = d[p++]); )
                    ...
                    else if (((c = yt.contains(r.ownerDocument, r)), (s = T(f.appendChild(r), "script")), c && C(s), n)) for (u = 0; (r = s[u++]); ) Gt.test(r.type || "") && n.push(r);
                return f;
            }
            function k() {
                return !0;
            ...
            function R(t, e, n) {
                ...
                return (
                    ...
                    n &&
                        ...
                        !vt.pixelMarginRight() && ce.test(s) && le.test(e) && ((i = a.width), (o = a.minWidth), (r = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = i), (a.minWidth = o), (a.maxWidth = r))),
                    void 0 !== s ? s + "" : s
                );
            }
            function P(t, e) {
            ...
            function G(t, e, n) {
                var i,
                    ...
                    u = c.props;
                for (Q(u, c.opts.specialEasing); r < s; r++) if ((i = G.prefilters[r].call(c, t, u, c.opts))) return yt.isFunction(i.stop) && (yt._queueHooks(c.elem, c.opts.queue).stop = yt.proxy(i.stop, i)), i;
                return (
                    yt.map(u, Y, c),
                                ...
                                (n = s[e]),
                                    ...
                                    s !== i &&
                                        (c && i && (yt.isPlainObject(i) || (o = Array.isArray(i)))
                                            ? (o ? ((o = !1), (r = n && Array.isArray(n) ? n : [])) : (r = n && yt.isPlainObject(n) ? n : {}), (s[e] = yt.extend(c, r, i)))
                                            : void 0 !== i && (s[e] = i));
                    return s;
                }),
                yt.extend({
                    ...
                    (A = e.setDocument = function (t) {
                        ...
                        return i !== j && 9 === i.nodeType && i.documentElement
                            ? ((j = i),
                              ...
                              (x.matchesSelector = ht.test((R = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector))) &&
                                  o(function (t) {
                        ...
                        preFilter: {
                            ...
                            PSEUDO: function (t) {
                                ...
                                return ft.CHILD.test(t[0])
                                    ? null
                                    : (t[3] ? (t[2] = t[4] || t[5] || "") : n && ct.test(n) && (e = E(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && ((t[0] = t[0].slice(0, e)), (t[2] = n.slice(0, e))), t.slice(0, 3));
                            },
                        },
                        filter: {
                            TAG: function (t) {
                                    ...
                                    : function (e, n, l) {
                                          ...
                                          if (m) {
                                              ...
                                              if (((h = [s ? m.firstChild : m.lastChild]), s && y)) {
                                                  for (
                                                      d = m, f = d[F] || (d[F] = {}), u = f[d.uniqueID] || (f[d.uniqueID] = {}), c = u[t] || [], p = c[0] === W && c[1], b = p && c[2], d = p && m.childNodes[p];
                                                  ...
                                                  for (
                                                      ;
                                                      (d = (++p && d && d[g]) || (b = p = 0) || h.pop()) &&
                                                      ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (y && ((f = d[F] || (d[F] = {})), (u = f[d.uniqueID] || (f[d.uniqueID] = {})), (u[t] = [W, b])), d !== e));
                        ...
                        for (
                            ...
                            (a = ne.exec(e[c]) || []),
                                ...
                                p &&
                                    ...
                                    (f = yt.event.special[p] || {}),
                                    (u = yt.extend({ type: p, origType: g, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && yt.expr.match.needsContext.test(o), namespace: h.join(".") }, r)),
                                    (d = l[p]) || ((d = l[p] = []), (d.delegateCount = 0), (f.setup && !1 !== f.setup.call(t, i, h, s)) || (t.addEventListener && t.addEventListener(p, s))),
                    ...
                    if (
                        ...
                        return (
                            ...
                            o ||
                                ...
                                !Pt(i) ||
                                (c && yt.isFunction(i[p]) && !yt.isWindow(i) && ((a = i[c]), a && (i[c] = null), (yt.event.triggered = p), i[p](), (yt.event.triggered = void 0), a && (i[c] = a))),
                            t.result
                        );
                    }
                },
                            ...
                            u ||
                                ...
                                c
                                    ? (h.ifModified && ((w = C.getResponseHeader("Last-Modified")), w && (yt.lastModified[r] = w), (w = C.getResponseHeader("etag")) && (yt.etag[r] = w)),
                                      204 === t || "HEAD" === h.type ? (T = "nocontent") : 304 === t ? (T = "notmodified") : ((T = x.state), (d = x.data), (p = x.error), (c = !p)))
